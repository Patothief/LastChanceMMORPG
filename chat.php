...
$sql = "SELECT * FROM (SELECT chat.player_id, chat.message, chat.time_created, player.playername FROM chat JOIN player ON chat.player_id = player.id ORDER BY chat.time_created DESC LIMIT 15) AS sub ORDER BY time_created ASC";
